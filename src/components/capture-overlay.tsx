  ...
  return (
    ...
    >
      ...
      {sel && sel.width > 0 && sel.height > 0 && (
        <div style={{ position: "absolute", left: sel.x, top: sel.y, width: sel.width, height: sel.height, border: "2px solid rgba(255,255,255,0.95)", boxShadow: "0 0 0 1px rgba(0,0,0,0.3)", pointerEvents: "none" }}>
          {/* Size badge */}
          ...
          {[
            ...
            <div key={i} style={{ position: "absolute", width: HANDLE_SIZE, height: HANDLE_SIZE, background: "white", boxShadow: "0 0 0 1px rgba(0,0,0,0.4)", borderRadius: 2, ...style }} />
          ))}
        </div>
      )}
